...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["SpriteViewerFlareAnimation"] = $PS["SpriteViewerFlareAnimation"] || {};
  var exports = $PS["SpriteViewerFlareAnimation"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
      ...
      return function (ctx) {
          return function (img) {
              return function (state) {
                  var frame = Data_Maybe.fromJust()(Data_Foldable.indexl(Data_Foldable.foldableArray)(state.currentFrame)(sprite));
                  return function __do() {
                      ...
                      var v1 = Graphics_Canvas.drawImageFull(ctx)(img)(frame.x)(frame.y)(frame.w)(frame.h)(0.0)(0.0)(frame.w)(frame.h)();
  ...
  var plot = function (prev) {
      return function (current) {
          var currentFrame$prime = (function () {
              if (prev.firstFrame !== current.firstFrame || prev.lastFrame !== current.lastFrame) {
                  return current.firstFrame;
              };
              if (current.currentFrame === current.lastFrame) {
                  return current.firstFrame;
              };
              if (Data_Boolean.otherwise) {
                  return current.currentFrame + 1 | 0;
              };
              throw new Error("Failed pattern match at SpriteViewerFlareAnimation (line 39, column 5 - line 42, column 45): " + [  ]);
          })();
          return {
              currentFrame: currentFrame$prime,
              firstFrame: current.firstFrame,
              lastFrame: current.lastFrame
          };
      };
  };
  var makeUi = function (max) {
      return Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(toState)(Flare.intRange("First Frame")(0)(max)(0)))(Flare.intRange("Last Frame")(0)(max)(0)))(Flare.lift(Signal_DOM.animationFrame));
  };
  var initialState = function (max) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Signal_DOM.animationFrame))(function (v) {
      ...
      var ui = makeUi(max);
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(initialState(max)))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Sprite.loadImage("../art/adventurer-Sheet.png"))(function (v2) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Graphics_Canvas.getCanvasElementById("canvas")))(function (v3) {
                  var canvas = Data_Maybe.fromJust()(v3);
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Graphics_Canvas.getContext2D(canvas)))(function (v4) {
                      var game = Flare.foldp(plot)(v1)(ui);
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Flare.runFlareWith("controls")(render(sprite)(v4)(v2))(game));
                  });
              });
          });
      });
...
PS["SpriteViewerFlareAnimation"].main();